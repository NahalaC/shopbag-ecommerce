...
(function (global, factory) {
  ...
  EventManager.prototype.eventElement = function eventElement (element) {
    let ee = this.eventElements.filter(function (ee) { return ee.element === element })[0]
    if (!ee) {
  ...
  function keyboard (i) {
    ...
    const elementHovered = function () { return matches(element, ':hover') }
    const scrollbarFocused = function () { return matches(i.scrollbarX, ':focus') || matches(i.scrollbarY, ':focus') }
  ...
  const PerfectScrollbar = function PerfectScrollbar (element, userSettings) {
    ...
    const focus = function () { return element.classList.add(cls.state.focus) }
    const blur = function () { return element.classList.remove(cls.state.focus) }
